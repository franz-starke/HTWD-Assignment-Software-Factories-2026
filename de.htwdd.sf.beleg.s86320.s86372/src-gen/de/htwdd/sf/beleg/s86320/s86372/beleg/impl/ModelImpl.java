...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
   ...
   */
  @Override
  public EList<S> getStory()
  {
    if (story == null)
    {
      story = new EObjectContainmentEList<S>(S.class, this, BelegPackage.MODEL__STORY);
    }
    return story;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case BelegPackage.MODEL__STORY:
        getStory().clear();
        getStory().addAll((Collection<? extends S>)newValue);
        return;
    }
